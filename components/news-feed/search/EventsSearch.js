...
<div className="sticky top-7 z-50 flex items-center w-full mt-7 gap-2">
  <label className="relative block">
    ...
    <input
      ...
      placeholder="Search Events" type="text" name="search" />
  </label>
  <div className="">
    <div className="">
      <Popover className="relative">
        {({ open }) => (
        <>
          <Popover.Button className={` ${ open ? "" : "text-opacity-90 focus-visible:outline-none" }`}>
            <div className="">
          ...
          <Transition as={Fragment} enter="transition ease-out duration-200" enterFrom="opacity-0 translate-y-1"
            ...
            <Popover.Panel
              className="absolute left-1/2 z-10 mt-3 w-36 max-w-sm -translate-x-full transform px-4 sm:px-0 lg:max-w-3xl">
