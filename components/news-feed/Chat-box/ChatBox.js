                    ...
                    <div className="absolute  w-full">
                      ...
                      <div className="tab-content tab-space pt-2.5">
                        <div className={openTab === 1 ? "block" : "hidden"} id="link1">
                          <div>
                            <input placeholder="Search Chat.." className="border-1 rounded border-indigo-400 w-full p-2 placeholder:font-light focus:border-indigo-400 active:border-indigo-400 focus-visible:border-indigo-400 " />
                          </div>
                        ...
                        <div className={openTab === 2 ? "block" : "hidden"} id="link2">
                          <div>
                            <input placeholder="Search New Friends.." className="border-1 rounded border-indigo-400 w-full p-2 placeholder:font-light focus:border-indigo-400 active:border-indigo-400 focus-visible:border-indigo-400 " />
                          </div>
                          <div className=" bg-gray-100 p-2 border-b"
                            ref={btnDropdownRef1}
                            onClick={() => {
