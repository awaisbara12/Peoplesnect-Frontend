...
const AboutUs = () => {
  return (
    <div className="bg-cover bg-no-repeat bg-bottom  opacity-100 bg-[url('../public/images/about-bg.jpg')] h-full bg-fixed w-full">
      <div className="bg-white p-3 h-auto bg-opacity-75">
        <div className="px-4 md:py-12 my-4 md:my-8">
          <div className="text-xl md:text-6xl mt-2 md:mt-12 font-bold">
            About PeoplesNect
          </div>
          <div className=" mt-3 w-full text-base md:text-xl pl-8">
            Welcome to <span className="text-indigo-400 font-bold">PeoplesNect</span>, the worlds largest professional network with more than
            930 million members in more than 200 countries and territories worldwide.
          </div>
          <div className="text-xl md:text-6xl  mt-12 font-bold">
            Vision
          </div>
          <div className=" mt-3 w-full text-base md:text-xl pl-8">
