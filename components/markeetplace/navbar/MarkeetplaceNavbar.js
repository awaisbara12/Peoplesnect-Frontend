...
const MarkeetplaceNavbar = () => {
  return (
    <div className="navbar flex items-center justify-between pt-8">
        ...
        <Link href="">
          <a>
            <div className="relative">
              ...
              <div className="flex items-center justify-center absolute top-0 right-0 text-white p-1  text-xs bg-red-400 rounded-full">
