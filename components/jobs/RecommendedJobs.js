      ...
      <div className="w-[620px] xl:w-[980px] lg:w-[730px] md:w-[780px] px-5 md:px-0 xl:px-0 lg:px-0">
        <div className="">
          ...
          <div className="mt-8 text-center">
            <button className="border border-transparent font-bold text-xl bg-indigo-400 px-4 py-2 rounded-full text-white hover:bg-white hover:border-indigo-400 hover:text-indigo-400">Load More</button>
          </div>
