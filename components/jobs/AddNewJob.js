                    ...
                    <div className="bg-white px-12 py-5 rounded-xl">
                      <form className="w-full">
                        <div className="grid grid-cols-2 md:grid-cols-5 items-end">
                          <div className="w-full relative flex items-center justify-start underline">
                            {postImagePreview ? ('') : (
                              <div className="relative flex gap-1 md:gap-2 items-center border p-4">
                                <div className="relative flex items-center justify-center">
                                  ...
                                  <input
                                    ...
                                    name="image"
                                    id="image"
                                    className="opacity-0  cursor-pointer absolute w-26 h-26 -z-0"
                                    onChange={handleImagePost}
                                    title={""}
                                    multiple
                                  />
                                </div>
                                <div className="font-extralight">Upload Logo</div>
                              </div>
                            )}
                            {postImagePreview ? (
                              <div className={`relative`}>
                                <img src={postImagePreview} className="object-cover rounded-full z-40 h-[100px] w-[100px] " alt="" />
                                <div onClick={handleCoverReomve} className="bg-indigo-100 absolute bottom-0 right-0 z-50 w-6 h-6 cursor-pointer flex justify-center items-center rounded-full" >
                              ...
                              <div className="flex min-h-full items-center justify-center p-4 text-center">
                                ...
                                >
                                  <Dialog.Panel className="w-[620px] bg-white rounded-xl xl:w-[980px] lg:w-[730px] md:w-[780px] px-5 md:px-0 lg:px-0 py-4 text-left align-middle shadow-xl transition-all">
                                    ...
                                    <div>
                                      <div className="w-full flex flex-row items-center justify-center px-24 py-6">
                                        <div className="stepper-item w-8 h-8 font-medium border-2 bg-indigo-400 text-white rounded-full flex justify-center items-center">
                                          <button
                                            onClick={closeModal1}
                                          >1</button>
                                        </div>
