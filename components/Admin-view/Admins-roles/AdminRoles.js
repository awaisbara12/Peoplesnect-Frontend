...
const AdminRoles = () => {
  ...
  const GetUsers = async()=>{      
    await fetch(ADMIN_USER_API+"/has_admin_role?"+"page=" + currentpage, {
      method: "GET",
      headers: {
  ...
  const searchuser = async()=>{      
    await fetch(ADMIN_USER_API+"/has_admin_role?"+"?page=1", {
      method: "GET",
      headers: {
        Accept: "application/json", 
        Authorization: `${authKey}`,
  ...
  const searchmultiples  = async(event) =>{
    if (!event?.length>0){
      ...
      await fetch(ADMIN_USER_API+"/admin_search"+"?query="+event, {
        method: "GET",
         headers: {
          Accept: "application/json", 
           Authorization: `${authKey}`,
  ...
  const searchmultiples2  = async(event) =>{
    if (!event?.length>0){
      ...
      await fetch(ADMIN_USER_API+"/admin_search"+"?query="+event+"&page="+currentpage1, {
        method: "GET",
         headers: {
          Accept: "application/json", 
           Authorization: `${authKey}`,
          ...
          <div className="mt-8">
            <div>
              <div className="text-center">
                <div className="heading text-4xl font-semibold text-indigo-400">Admins List</div>
