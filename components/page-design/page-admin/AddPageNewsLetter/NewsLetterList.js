...
const NewsLetterList =()=> {
  ...
  const Getnewsletter = async()=>{      
    await fetch(MESSAGES_API+"/messenger_news_letters?id="+myArray[1]+"&type=Page&"+"page=" + currentpage, {
      method: "GET",
      headers: {
...
function openModal(i) {
  ...
  const searchJob = async()=>{      
    await fetch(MESSAGES_API+"/messenger_news_letters?id="+myArray[1]+"&type=Page&"+"page=1", {
      method: "GET",
      headers: {
        Accept: "application/json", 
        Authorization: `${authKey}`,
  ...
  const searchmultiples  = async(event) =>{
    if (!event?.length>0){
      ...
      await fetch(MESSAGES_API+"/messenger_news_letters_search"+"?type=Page"+"&id="+myArray[1]+"&query="+event, {
        method: "GET",
         headers: {
          Accept: "application/json", 
           Authorization: `${authKey}`,
  ...
  const searchmultiples2  = async(event) =>{
    if (!event?.length>0){
      ...
      await fetch(MESSAGES_API+"/messenger_news_letters_search"+"?type=Page"+"&id="+myArray[1]+"&query="+event+"&page="+currentpage1, {
        method: "GET",
         headers: {
          Accept: "application/json", 
           Authorization: `${authKey}`,
        ...
        <div className="mt-8">
          <div className="">
            ...
            <div className="flex justify-end">
              <Link href={{ pathname: "/page-design/AddNews-Letter/NewsLetter-List", query: myArray[1], }}>
