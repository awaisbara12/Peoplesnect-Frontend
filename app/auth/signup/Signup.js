  ...
  return (
    <div className="signUp--background min-h-screen overflow-y-auto">
      <div className="block md:flex items-center justify-start">
        <div className="w-full xl:w-[64%] h-screen flex flex-col justify-between ml-auto relative z-50">
          <div className="flex justify-center items-start pt-24">
            <div className="w-11/12 xl:w-1/2 lg:w-1/2 bg-white py-8 px-8 mb-6 rounded-xl">
              ...
              <form action="#" className="relative z-10">
                ...
                <button className="bg-indigo-400 text-white text-xl font-semibold w-full py-2 rounded-full mt-6">
                  Join Now
                </button>
